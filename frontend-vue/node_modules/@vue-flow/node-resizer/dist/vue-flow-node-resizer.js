...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const isHandleControl = vue.toRef(() => props.variant === ResizeControlVariant.Handle);
    const scale = vue.computed(() => isHandleControl.value && props.autoScale ? `${Math.max(1 / viewport.value.zoom, 1)}` : void 0);
