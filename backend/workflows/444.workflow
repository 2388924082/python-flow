  ...
  "nodes": [
    {
      ...
      "type": "node_1775383699193",
      "name": "数据输入",
      "icon": "📥",
      "category": "input",
      "position": {
        "x": 161.0847759771347,
        "y": -35.360848813678984
      },
      "config": [
        {
          "key": "data",
    ...
    },
    {
      ...
      "type": "node_1775383701377",
      "name": "数据日志",
      "icon": "📝",
      "category": "debug",
      "position": {
        "x": 402.55472364857434,
        "y": 58.32421285119651
      },
      "config": [
        {
    ...
    },
    {
      ...
      "type": "node_1775383703953",
      "name": "数据输出",
      "icon": "📤",
      "category": "output",
      "position": {
        "x": 684.9294165539737,
        "y": 371.04758770437246
      },
      "config": [],
      "inputs": [
        {
    ...
    },
    {
      ...
      "type": "node_1775383766426",
      "name": "CSV转换器",
      "icon": "📊",
      "category": "process",
      "position": {
        "x": 564.8541966736403,
        "y": 13.460943884918109
      },
      "config": [
        {
          "key": "delimiter",
